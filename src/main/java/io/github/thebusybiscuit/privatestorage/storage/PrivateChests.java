...
public class PrivateChests {
    ...
    public PrivateChests(PrivateStorage plugin, ItemGroup itemGroup) {
        ...
        safeBirch = new SlimefunItemStack("PRIVATE_SAFE_BIRCH", "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMjdmN2NiMmQ0ZWMwZTBjNjFlNzlhMDZjZjA0YjBkMTYxMDVmNzdkYTk2OTEzYTY4OWE0ZGM5NTI3N2I5MzczYiJ9fX0=", "&6白桦木保险箱", getLore(2, false));
    ...
    public void registerResearches(PrivateStorage plugin) {
        new Research(new NamespacedKey(plugin, "wooden_safes"), 609, "魔法存储", 8).addItems(safeOak, safeBirch, safeSpruce, safeJungle, safeAcacia, safeDarkOak).register();
        new Research(new NamespacedKey(plugin, "metal_safes"), 610, "升级存储", 16).addItems(safeIron, safeGold, safeDiamond).register();
        new Research(new NamespacedKey(plugin, "gem_safes"), 611, "顶级存储", 20).addItems(safeEmerald).register();
        new Research(new NamespacedKey(plugin, "hardened_safes"), 612, "硬化存储", 24).addItems(safeObsidian, safeSteel).register();
    }
